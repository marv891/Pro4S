...
class Ui_MainWindow(GUI_functions):
    def __init__(self):
        ...
        self.VideoStream.setMinimumSize(QtCore.QSize(750, 600))
        self.VideoStream.setMaximumSize(QtCore.QSize(750, 600))
        self.VideoStream.setSizeIncrement(QtCore.QSize(5, 4))
        self.VideoStream.setBaseSize(QtCore.QSize(1280, 1024))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.zoomSlider.valueChanged.connect(self.zoom_slide)
